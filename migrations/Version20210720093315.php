 ...
 */
final class Version20210720093315 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, publication DATE NOT NULL, brochure_filename VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
